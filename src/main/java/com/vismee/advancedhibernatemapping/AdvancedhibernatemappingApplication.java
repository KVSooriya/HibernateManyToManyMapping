...
public class AdvancedhibernatemappingApplication {
	...
	private void addCoursesForStudent(AppDAO appDAO)
	{
		...
		student.addCourse(new Course("HTML, CSS and Javascript"));
		student.addCourse(new Course("AWS certification"));
	...
	private void createCourseWithStudents(AppDAO appDAO)
	{
		...
		course.addStudent(new Student("Bhargav","Parithi","parithi2023@gmail.com"));
		course.addStudent(new Student("Dijesh","Sabari","dijesh2023@gmail.com"));
